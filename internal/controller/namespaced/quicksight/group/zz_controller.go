...
import (
	...
	v1beta1 "github.com/upbound/provider-aws/v2/apis/namespaced/quicksight/v1beta1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginSDKAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["aws_quicksight_group"],
