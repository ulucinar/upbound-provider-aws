...
// SetupWebhookWithManager registers the conversion webhook for TableItem.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1beta1.TableItem{}).
		Complete(); err != nil {
...
// SetupGated adds a controller that reconciles TableItem managed resources.
func SetupGated(mgr ctrl.Manager, o tjcontroller.Options) error {
	o.Options.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			mgr.GetLogger().Error(err, "unable to setup reconciler", "gvk", v1beta1.TableItem_GroupVersionKind.String())
		}
	}, v1beta1.TableItem_GroupVersionKind)
	return nil
}
