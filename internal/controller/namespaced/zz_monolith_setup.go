...
import (
	...
	project "github.com/upbound/provider-aws/v2/internal/controller/namespaced/codebuild/project"
	reportgroup "github.com/upbound/provider-aws/v2/internal/controller/namespaced/codebuild/reportgroup"
	sourcecredential "github.com/upbound/provider-aws/v2/internal/controller/namespaced/codebuild/sourcecredential"
	webhookcodebuild "github.com/upbound/provider-aws/v2/internal/controller/namespaced/codebuild/webhook"
	...
	projectdevicefarm "github.com/upbound/provider-aws/v2/internal/controller/namespaced/devicefarm/project"
	...
	repositorycreationtemplate "github.com/upbound/provider-aws/v2/internal/controller/namespaced/ecr/repositorycreationtemplate"
	...
	webaclrulegroupassociation "github.com/upbound/provider-aws/v2/internal/controller/namespaced/wafv2/webaclrulegroupassociation"
...
func SetupWebhookWithManager_monolith(mgr ctrl.Manager) error {
	for _, setup := range []func(ctrl.Manager) error{
		...
		certificateacmpca.SetupWebhookWithManager,
		...
		apimapping.SetupWebhookWithManager,
		authorizerapigatewayv2.SetupWebhookWithManager,
		deploymentapigatewayv2.SetupWebhookWithManager,
		domainnameapigatewayv2.SetupWebhookWithManager,
		integrationapigatewayv2.SetupWebhookWithManager,
		integrationresponseapigatewayv2.SetupWebhookWithManager,
		...
		target.SetupWebhookWithManager,
		application.SetupWebhookWithManager,
		configurationprofile.SetupWebhookWithManager,
		deploymentappconfig.SetupWebhookWithManager,
		deploymentstrategy.SetupWebhookWithManager,
		environment.SetupWebhookWithManager,
		extension.SetupWebhookWithManager,
		extensionassociation.SetupWebhookWithManager,
		hostedconfigurationversion.SetupWebhookWithManager,
		flow.SetupWebhookWithManager,
		eventintegration.SetupWebhookWithManager,
		applicationapplicationinsights.SetupWebhookWithManager,
		gatewayroute.SetupWebhookWithManager,
		mesh.SetupWebhookWithManager,
		routeappmesh.SetupWebhookWithManager,
		...
		directoryconfig.SetupWebhookWithManager,
		fleet.SetupWebhookWithManager,
		fleetstackassociation.SetupWebhookWithManager,
		imagebuilder.SetupWebhookWithManager,
		stack.SetupWebhookWithManager,
		user.SetupWebhookWithManager,
		userstackassociation.SetupWebhookWithManager,
		apicache.SetupWebhookWithManager,
		apikeyappsync.SetupWebhookWithManager,
		datasource.SetupWebhookWithManager,
		function.SetupWebhookWithManager,
		graphqlapi.SetupWebhookWithManager,
		resolver.SetupWebhookWithManager,
		...
		policyautoscaling.SetupWebhookWithManager,
		schedule.SetupWebhookWithManager,
		scalingplan.SetupWebhookWithManager,
		...
		computeenvironment.SetupWebhookWithManager,
		...
		resourcecloudcontrol.SetupWebhookWithManager,
		stackcloudformation.SetupWebhookWithManager,
		...
		domainserviceaccesspolicy.SetupWebhookWithManager,
		eventdatastore.SetupWebhookWithManager,
		trail.SetupWebhookWithManager,
		compositealarm.SetupWebhookWithManager,
		dashboard.SetupWebhookWithManager,
		metricalarm.SetupWebhookWithManager,
		metricstream.SetupWebhookWithManager,
		apidestination.SetupWebhookWithManager,
		archive.SetupWebhookWithManager,
		bus.SetupWebhookWithManager,
		buspolicy.SetupWebhookWithManager,
		connectioncloudwatchevents.SetupWebhookWithManager,
		...
		domainpermissionspolicy.SetupWebhookWithManager,
		repository.SetupWebhookWithManager,
		repositorypermissionspolicy.SetupWebhookWithManager,
		project.SetupWebhookWithManager,
		reportgroup.SetupWebhookWithManager,
		sourcecredential.SetupWebhookWithManager,
		webhookcodebuild.SetupWebhookWithManager,
		approvalruletemplate.SetupWebhookWithManager,
		approvalruletemplateassociation.SetupWebhookWithManager,
		repositorycodecommit.SetupWebhookWithManager,
		trigger.SetupWebhookWithManager,
		profilinggroup.SetupWebhookWithManager,
		codepipeline.SetupWebhookWithManager,
		customactiontype.SetupWebhookWithManager,
		webhookcodepipeline.SetupWebhookWithManager,
		connectioncodestarconnections.SetupWebhookWithManager,
		...
		usercognitoidp.SetupWebhookWithManager,
		...
		awsconfigurationrecorderstatus.SetupWebhookWithManager,
		configrule.SetupWebhookWithManager,
		configurationaggregator.SetupWebhookWithManager,
		configurationrecorder.SetupWebhookWithManager,
		conformancepack.SetupWebhookWithManager,
		deliverychannel.SetupWebhookWithManager,
		remediationconfiguration.SetupWebhookWithManager,
		...
		certificatedms.SetupWebhookWithManager,
		endpoint.SetupWebhookWithManager,
		eventsubscription.SetupWebhookWithManager,
		replicationinstance.SetupWebhookWithManager,
		replicationsubnetgroup.SetupWebhookWithManager,
		replicationtask.SetupWebhookWithManager,
		s3endpoint.SetupWebhookWithManager,
		clusterdocdb.SetupWebhookWithManager,
		...
		eventsubscriptiondocdb.SetupWebhookWithManager,
		globalcluster.SetupWebhookWithManager,
		subnetgroupdocdb.SetupWebhookWithManager,
		conditionalforwarder.SetupWebhookWithManager,
		directory.SetupWebhookWithManager,
		shareddirectory.SetupWebhookWithManager,
		clusterdsql.SetupWebhookWithManager,
		clusterpeering.SetupWebhookWithManager,
		...
		resourcepolicydynamodb.SetupWebhookWithManager,
		...
		ami.SetupWebhookWithManager,
		amicopy.SetupWebhookWithManager,
		amilaunchpermission.SetupWebhookWithManager,
		availabilityzonegroup.SetupWebhookWithManager,
		capacityreservation.SetupWebhookWithManager,
		carriergateway.SetupWebhookWithManager,
		customergateway.SetupWebhookWithManager,
		defaultnetworkacl.SetupWebhookWithManager,
		defaultroutetable.SetupWebhookWithManager,
		defaultsecuritygroup.SetupWebhookWithManager,
		defaultsubnet.SetupWebhookWithManager,
		defaultvpc.SetupWebhookWithManager,
		defaultvpcdhcpoptions.SetupWebhookWithManager,
		ebsdefaultkmskey.SetupWebhookWithManager,
		ebsencryptionbydefault.SetupWebhookWithManager,
		ebssnapshot.SetupWebhookWithManager,
		ebssnapshotcopy.SetupWebhookWithManager,
		ebssnapshotimport.SetupWebhookWithManager,
		ebsvolume.SetupWebhookWithManager,
		egressonlyinternetgateway.SetupWebhookWithManager,
		eip.SetupWebhookWithManager,
		eipassociation.SetupWebhookWithManager,
		fleetec2.SetupWebhookWithManager,
		flowlog.SetupWebhookWithManager,
		hostec2.SetupWebhookWithManager,
		instanceec2.SetupWebhookWithManager,
		instancestate.SetupWebhookWithManager,
		internetgateway.SetupWebhookWithManager,
		keypair.SetupWebhookWithManager,
		launchtemplate.SetupWebhookWithManager,
		mainroutetableassociation.SetupWebhookWithManager,
		managedprefixlist.SetupWebhookWithManager,
		managedprefixlistentry.SetupWebhookWithManager,
		natgateway.SetupWebhookWithManager,
		networkacl.SetupWebhookWithManager,
		networkaclrule.SetupWebhookWithManager,
		networkinsightsanalysis.SetupWebhookWithManager,
		networkinsightspath.SetupWebhookWithManager,
		networkinterface.SetupWebhookWithManager,
		networkinterfaceattachment.SetupWebhookWithManager,
		networkinterfacesgattachment.SetupWebhookWithManager,
		placementgroup.SetupWebhookWithManager,
		routeec2.SetupWebhookWithManager,
		routetable.SetupWebhookWithManager,
		routetableassociation.SetupWebhookWithManager,
		securitygroup.SetupWebhookWithManager,
		securitygroupegressrule.SetupWebhookWithManager,
		securitygroupingressrule.SetupWebhookWithManager,
		securitygrouprule.SetupWebhookWithManager,
		serialconsoleaccess.SetupWebhookWithManager,
		snapshotcreatevolumepermission.SetupWebhookWithManager,
		spotdatafeedsubscription.SetupWebhookWithManager,
		spotfleetrequest.SetupWebhookWithManager,
		spotinstancerequest.SetupWebhookWithManager,
		subnet.SetupWebhookWithManager,
		subnetcidrreservation.SetupWebhookWithManager,
		tagec2.SetupWebhookWithManager,
		trafficmirrorfilter.SetupWebhookWithManager,
		trafficmirrorfilterrule.SetupWebhookWithManager,
		transitgateway.SetupWebhookWithManager,
		transitgatewayconnect.SetupWebhookWithManager,
		transitgatewayconnectpeer.SetupWebhookWithManager,
		transitgatewaymulticastdomain.SetupWebhookWithManager,
		transitgatewaymulticastdomainassociation.SetupWebhookWithManager,
		transitgatewaymulticastgroupmember.SetupWebhookWithManager,
		transitgatewaymulticastgroupsource.SetupWebhookWithManager,
		transitgatewaypeeringattachment.SetupWebhookWithManager,
		transitgatewaypeeringattachmentaccepter.SetupWebhookWithManager,
		transitgatewaypolicytable.SetupWebhookWithManager,
		transitgatewayprefixlistreference.SetupWebhookWithManager,
		transitgatewayroute.SetupWebhookWithManager,
		transitgatewayroutetable.SetupWebhookWithManager,
		transitgatewayroutetableassociation.SetupWebhookWithManager,
		transitgatewayroutetablepropagation.SetupWebhookWithManager,
		transitgatewayvpcattachment.SetupWebhookWithManager,
		transitgatewayvpcattachmentaccepter.SetupWebhookWithManager,
		volumeattachment.SetupWebhookWithManager,
		vpc.SetupWebhookWithManager,
		vpcdhcpoptions.SetupWebhookWithManager,
		vpcdhcpoptionsassociation.SetupWebhookWithManager,
		vpcendpoint.SetupWebhookWithManager,
		vpcendpointconnectionaccepter.SetupWebhookWithManager,
		vpcendpointconnectionnotification.SetupWebhookWithManager,
		vpcendpointroutetableassociation.SetupWebhookWithManager,
		vpcendpointsecuritygroupassociation.SetupWebhookWithManager,
		vpcendpointservice.SetupWebhookWithManager,
		vpcendpointserviceallowedprincipal.SetupWebhookWithManager,
		vpcendpointsubnetassociation.SetupWebhookWithManager,
		vpcipam.SetupWebhookWithManager,
		vpcipampool.SetupWebhookWithManager,
		vpcipampoolcidr.SetupWebhookWithManager,
		vpcipampoolcidrallocation.SetupWebhookWithManager,
		vpcipamscope.SetupWebhookWithManager,
		vpcipv4cidrblockassociation.SetupWebhookWithManager,
		vpcpeeringconnection.SetupWebhookWithManager,
		vpcpeeringconnectionaccepter.SetupWebhookWithManager,
		vpcpeeringconnectionoptions.SetupWebhookWithManager,
		vpnconnection.SetupWebhookWithManager,
		vpnconnectionroute.SetupWebhookWithManager,
		vpngateway.SetupWebhookWithManager,
		vpngatewayattachment.SetupWebhookWithManager,
		vpngatewayroutepropagation.SetupWebhookWithManager,
		lifecyclepolicyecr.SetupWebhookWithManager,
		...
		clusterelasticache.SetupWebhookWithManager,
		globalreplicationgroup.SetupWebhookWithManager,
		parametergroupelasticache.SetupWebhookWithManager,
		replicationgroup.SetupWebhookWithManager,
		serverlesscache.SetupWebhookWithManager,
		subnetgroupelasticache.SetupWebhookWithManager,
		userelasticache.SetupWebhookWithManager,
		usergroupelasticache.SetupWebhookWithManager,
		applicationelasticbeanstalk.SetupWebhookWithManager,
		applicationversion.SetupWebhookWithManager,
		configurationtemplate.SetupWebhookWithManager,
		domainelasticsearch.SetupWebhookWithManager,
		domainpolicy.SetupWebhookWithManager,
		domainsamloptions.SetupWebhookWithManager,
		pipelineelastictranscoder.SetupWebhookWithManager,
		preset.SetupWebhookWithManager,
		appcookiestickinesspolicy.SetupWebhookWithManager,
		attachmentelb.SetupWebhookWithManager,
		...
		policyelb.SetupWebhookWithManager,
		...
		virtualcluster.SetupWebhookWithManager,
		applicationemrserverless.SetupWebhookWithManager,
		feature.SetupWebhookWithManager,
		projectevidently.SetupWebhookWithManager,
		segment.SetupWebhookWithManager,
		deliverystream.SetupWebhookWithManager,
		...
		build.SetupWebhookWithManager,
		fleetgamelift.SetupWebhookWithManager,
		gamesessionqueue.SetupWebhookWithManager,
		script.SetupWebhookWithManager,
		vaultglacier.SetupWebhookWithManager,
		...
		connectionglue.SetupWebhookWithManager,
		...
		triggerglue.SetupWebhookWithManager,
		...
		groupidentitystore.SetupWebhookWithManager,
		groupmembershipidentitystore.SetupWebhookWithManager,
		useridentitystore.SetupWebhookWithManager,
		...
		assessmenttarget.SetupWebhookWithManager,
		assessmenttemplate.SetupWebhookWithManager,
		resourcegroup.SetupWebhookWithManager,
		enabler.SetupWebhookWithManager,
		authorizeriot.SetupWebhookWithManager,
		certificateiot.SetupWebhookWithManager,
		...
		policyiot.SetupWebhookWithManager,
		...
		recordingconfiguration.SetupWebhookWithManager,
		clusterkafka.SetupWebhookWithManager,
		...
		datasourcekendra.SetupWebhookWithManager,
		...
		keyspace.SetupWebhookWithManager,
		tablekeyspaces.SetupWebhookWithManager,
		streamkinesis.SetupWebhookWithManager,
		streamconsumer.SetupWebhookWithManager,
		applicationkinesisanalytics.SetupWebhookWithManager,
		applicationkinesisanalyticsv2.SetupWebhookWithManager,
		applicationsnapshot.SetupWebhookWithManager,
		streamkinesisvideo.SetupWebhookWithManager,
		aliaskms.SetupWebhookWithManager,
		ciphertext.SetupWebhookWithManager,
		externalkey.SetupWebhookWithManager,
		grant.SetupWebhookWithManager,
		key.SetupWebhookWithManager,
		replicaexternalkey.SetupWebhookWithManager,
		replicakey.SetupWebhookWithManager,
		datalakesettings.SetupWebhookWithManager,
		permissions.SetupWebhookWithManager,
		resourcelakeformation.SetupWebhookWithManager,
		aliaslambda.SetupWebhookWithManager,
		codesigningconfig.SetupWebhookWithManager,
		eventsourcemapping.SetupWebhookWithManager,
		functionlambda.SetupWebhookWithManager,
		...
		licenseconfiguration.SetupWebhookWithManager,
		bucket.SetupWebhookWithManager,
		certificatelightsail.SetupWebhookWithManager,
		containerservice.SetupWebhookWithManager,
		disk.SetupWebhookWithManager,
		diskattachment.SetupWebhookWithManager,
		domainlightsail.SetupWebhookWithManager,
		domainentry.SetupWebhookWithManager,
		instancelightsail.SetupWebhookWithManager,
		instancepublicports.SetupWebhookWithManager,
		keypairlightsail.SetupWebhookWithManager,
		lblightsail.SetupWebhookWithManager,
		...
		accountmacie2.SetupWebhookWithManager,
		...
		invitationacceptermacie2.SetupWebhookWithManager,
		membermacie2.SetupWebhookWithManager,
		queuemediaconvert.SetupWebhookWithManager,
		channelmedialive.SetupWebhookWithManager,
		input.SetupWebhookWithManager,
		inputsecuritygroup.SetupWebhookWithManager,
		multiplex.SetupWebhookWithManager,
		channelmediapackage.SetupWebhookWithManager,
		container.SetupWebhookWithManager,
		containerpolicy.SetupWebhookWithManager,
		acl.SetupWebhookWithManager,
		clustermemorydb.SetupWebhookWithManager,
		parametergroupmemorydb.SetupWebhookWithManager,
		snapshot.SetupWebhookWithManager,
		subnetgroupmemorydb.SetupWebhookWithManager,
		usermemorydb.SetupWebhookWithManager,
		broker.SetupWebhookWithManager,
		configurationmq.SetupWebhookWithManager,
		usermq.SetupWebhookWithManager,
		environmentmwaa.SetupWebhookWithManager,
		clusterneptune.SetupWebhookWithManager,
		clusterendpoint.SetupWebhookWithManager,
		clusterinstanceneptune.SetupWebhookWithManager,
		clusterparametergroupneptune.SetupWebhookWithManager,
		clustersnapshotneptune.SetupWebhookWithManager,
		eventsubscriptionneptune.SetupWebhookWithManager,
		globalclusterneptune.SetupWebhookWithManager,
		parametergroupneptune.SetupWebhookWithManager,
		subnetgroupneptune.SetupWebhookWithManager,
		...
		connectionnetworkmanager.SetupWebhookWithManager,
		...
		domainopensearch.SetupWebhookWithManager,
		domainpolicyopensearch.SetupWebhookWithManager,
		...
		vpcendpointopensearchserverless.SetupWebhookWithManager,
		accountorganizations.SetupWebhookWithManager,
		...
		policyorganizations.SetupWebhookWithManager,
		policyattachmentorganizations.SetupWebhookWithManager,
		pipelineosis.SetupWebhookWithManager,
		apppinpoint.SetupWebhookWithManager,
		smschannel.SetupWebhookWithManager,
		pipe.SetupWebhookWithManager,
		providerconfig.SetupWebhookWithManager,
		ledger.SetupWebhookWithManager,
		streamqldb.SetupWebhookWithManager,
		groupquicksight.SetupWebhookWithManager,
		userquicksight.SetupWebhookWithManager,
		...
		clusterrds.SetupWebhookWithManager,
		clusteractivitystream.SetupWebhookWithManager,
		clusterendpointrds.SetupWebhookWithManager,
		clusterinstancerds.SetupWebhookWithManager,
		clusterparametergrouprds.SetupWebhookWithManager,
		clusterroleassociation.SetupWebhookWithManager,
		clustersnapshotrds.SetupWebhookWithManager,
		dbinstanceautomatedbackupsreplication.SetupWebhookWithManager,
		dbsnapshotcopy.SetupWebhookWithManager,
		eventsubscriptionrds.SetupWebhookWithManager,
		globalclusterrds.SetupWebhookWithManager,
		...
		snapshotrds.SetupWebhookWithManager,
		subnetgrouprds.SetupWebhookWithManager,
		authenticationprofile.SetupWebhookWithManager,
		clusterredshift.SetupWebhookWithManager,
		endpointaccess.SetupWebhookWithManager,
		eventsubscriptionredshift.SetupWebhookWithManager,
		hsmclientcertificate.SetupWebhookWithManager,
		hsmconfiguration.SetupWebhookWithManager,
		parametergroupredshift.SetupWebhookWithManager,
		scheduledactionredshift.SetupWebhookWithManager,
		...
		subnetgroupredshift.SetupWebhookWithManager,
		usagelimit.SetupWebhookWithManager,
		endpointaccessredshiftserverless.SetupWebhookWithManager,
		redshiftserverlessnamespace.SetupWebhookWithManager,
		resourcepolicyredshiftserverless.SetupWebhookWithManager,
		snapshotredshiftserverless.SetupWebhookWithManager,
		usagelimitredshiftserverless.SetupWebhookWithManager,
		workgroupredshiftserverless.SetupWebhookWithManager,
		groupresourcegroups.SetupWebhookWithManager,
		...
		associationroute53profiles.SetupWebhookWithManager,
		profileroute53profiles.SetupWebhookWithManager,
		resourceassociationroute53profiles.SetupWebhookWithManager,
		clusterroute53recoverycontrolconfig.SetupWebhookWithManager,
		...
		endpointroute53resolver.SetupWebhookWithManager,
		querylogconfig.SetupWebhookWithManager,
		querylogconfigassociation.SetupWebhookWithManager,
		ruleroute53resolver.SetupWebhookWithManager,
		ruleassociation.SetupWebhookWithManager,
		appmonitor.SetupWebhookWithManager,
		metricsdestination.SetupWebhookWithManager,
		buckets3.SetupWebhookWithManager,
		...
		accesspoints3control.SetupWebhookWithManager,
		accesspointpolicy.SetupWebhookWithManager,
		accountpublicaccessblock.SetupWebhookWithManager,
		multiregionaccesspoint.SetupWebhookWithManager,
		multiregionaccesspointpolicy.SetupWebhookWithManager,
		...
		schedulescheduler.SetupWebhookWithManager,
		schedulegroup.SetupWebhookWithManager,
		discoverer.SetupWebhookWithManager,
		registryschemas.SetupWebhookWithManager,
		schemaschemas.SetupWebhookWithManager,
		...
		accountsecurityhub.SetupWebhookWithManager,
		actiontarget.SetupWebhookWithManager,
		findingaggregator.SetupWebhookWithManager,
		insight.SetupWebhookWithManager,
		inviteaccepter.SetupWebhookWithManager,
		membersecurityhub.SetupWebhookWithManager,
		productsubscription.SetupWebhookWithManager,
		standardssubscription.SetupWebhookWithManager,
		...
		httpnamespace.SetupWebhookWithManager,
		privatednsnamespace.SetupWebhookWithManager,
		publicdnsnamespace.SetupWebhookWithManager,
		serviceservicediscovery.SetupWebhookWithManager,
		...
		platformapplication.SetupWebhookWithManager,
		smspreferences.SetupWebhookWithManager,
		topic.SetupWebhookWithManager,
		topicpolicy.SetupWebhookWithManager,
		topicsubscription.SetupWebhookWithManager,
		queuesqs.SetupWebhookWithManager,
		...
		associationssm.SetupWebhookWithManager,
		...
		domainswf.SetupWebhookWithManager,
		databasetimestreamwrite.SetupWebhookWithManager,
		tabletimestreamwrite.SetupWebhookWithManager,
		languagemodel.SetupWebhookWithManager,
		vocabularytranscribe.SetupWebhookWithManager,
		vocabularyfilter.SetupWebhookWithManager,
		connectortransfer.SetupWebhookWithManager,
		server.SetupWebhookWithManager,
		sshkey.SetupWebhookWithManager,
		tagtransfer.SetupWebhookWithManager,
		usertransfer.SetupWebhookWithManager,
		workflowtransfer.SetupWebhookWithManager,
		endpointverifiedaccess.SetupWebhookWithManager,
		groupverifiedaccess.SetupWebhookWithManager,
		instanceverifiedaccess.SetupWebhookWithManager,
		...
		rulewaf.SetupWebhookWithManager,
		...
		bytematchsetwafregional.SetupWebhookWithManager,
		geomatchsetwafregional.SetupWebhookWithManager,
		ipsetwafregional.SetupWebhookWithManager,
		ratebasedrulewafregional.SetupWebhookWithManager,
		regexmatchsetwafregional.SetupWebhookWithManager,
		regexpatternsetwafregional.SetupWebhookWithManager,
		rulewafregional.SetupWebhookWithManager,
		sizeconstraintsetwafregional.SetupWebhookWithManager,
		sqlinjectionmatchsetwafregional.SetupWebhookWithManager,
		webaclwafregional.SetupWebhookWithManager,
		xssmatchsetwafregional.SetupWebhookWithManager,
		ipsetwafv2.SetupWebhookWithManager,
		regexpatternsetwafv2.SetupWebhookWithManager,
		rulegroupwafv2.SetupWebhookWithManager,
		webaclwafv2.SetupWebhookWithManager,
		webaclassociation.SetupWebhookWithManager,
		webaclloggingconfiguration.SetupWebhookWithManager,
		webaclrulegroupassociation.SetupWebhookWithManager,
		directoryworkspaces.SetupWebhookWithManager,
		ipgroup.SetupWebhookWithManager,
		encryptionconfig.SetupWebhookWithManager,
		groupxray.SetupWebhookWithManager,
