...
package proxydefaulttargetgroup
...
// SetupWebhookWithManager registers the conversion webhook for ProxyDefaultTargetGroup.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1beta1.ProxyDefaultTargetGroup{}).
		Complete(); err != nil {
...
// SetupGated adds a controller that reconciles ProxyDefaultTargetGroup managed resources.
