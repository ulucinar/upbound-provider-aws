...
// SetupWebhookWithManager registers the conversion webhook for DirectoryBucket.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1beta1.DirectoryBucket{}).
		Complete(); err != nil {
...
// SetupGated adds a controller that reconciles DirectoryBucket managed resources.
func SetupGated(mgr ctrl.Manager, o tjcontroller.Options) error {
	o.Options.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			mgr.GetLogger().Error(err, "unable to setup reconciler", "gvk", v1beta1.DirectoryBucket_GroupVersionKind.String())
		}
	}, v1beta1.DirectoryBucket_GroupVersionKind)
	return nil
}
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	for _, i := range o.Provider.Resources["aws_s3_directory_bucket"].InitializerFns {
