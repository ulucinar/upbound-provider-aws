...
import (
	...
	v1beta2 "github.com/upbound/provider-aws/apis/kafka/v1beta2"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	for _, i := range o.Provider.Resources["aws_msk_cluster"].InitializerFns {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewNoForkAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["aws_msk_cluster"],
				...
				tjcontroller.WithNoForkAsyncMetricRecorder(metrics.NewMetricRecorder(v1beta2.Cluster_GroupVersionKind, mgr, o.PollInterval)),
