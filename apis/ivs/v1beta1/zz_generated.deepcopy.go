...
func (in *RecordingConfigurationInitParameters) DeepCopyInto(out *RecordingConfigurationInitParameters) {
	*out = *in
	if in.DestinationConfiguration != nil {
		...
		*out = make([]DestinationConfigurationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ThumbnailConfiguration != nil {
		...
		*out = make([]ThumbnailConfigurationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RecordingConfigurationParameters) DeepCopyInto(out *RecordingConfigurationParameters) {
	*out = *in
	if in.DestinationConfiguration != nil {
		in, out := &in.DestinationConfiguration, &out.DestinationConfiguration
		*out = make([]DestinationConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ThumbnailConfiguration != nil {
		in, out := &in.ThumbnailConfiguration, &out.ThumbnailConfiguration
		*out = make([]ThumbnailConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
