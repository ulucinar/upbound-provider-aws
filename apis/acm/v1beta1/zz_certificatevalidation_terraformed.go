...
// GetInitParameters of this CertificateValidation
func (tr *CertificateValidation) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CertificateValidation
func (tr *CertificateValidation) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this CertificateValidation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *CertificateValidation) LateInitialize(attrs []byte) (bool, error) {
	params := &CertificateValidationParameters{}
