...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudFormationStackInitParameters) DeepCopyInto(out *CloudFormationStackInitParameters) {
	*out = *in
...
func (in *CloudFormationStackInitParameters) DeepCopy() *CloudFormationStackInitParameters {
	if in == nil {
		return nil
	}
	out := new(CloudFormationStackInitParameters)
	in.DeepCopyInto(out)
	return out
}
