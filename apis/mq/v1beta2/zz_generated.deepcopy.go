...
func (in *BootstrapUsersInitParameters) DeepCopyInto(out *BootstrapUsersInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapUsersInitParameters.
func (in *BootstrapUsersInitParameters) DeepCopy() *BootstrapUsersInitParameters {
	if in == nil {
		return nil
	}
	out := new(BootstrapUsersInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BootstrapUsersObservation) DeepCopyInto(out *BootstrapUsersObservation) {
	*out = *in
	if in.ConsoleAccess != nil {
		in, out := &in.ConsoleAccess, &out.ConsoleAccess
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapUsersObservation.
func (in *BootstrapUsersObservation) DeepCopy() *BootstrapUsersObservation {
	if in == nil {
		return nil
	}
	out := new(BootstrapUsersObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BootstrapUsersParameters) DeepCopyInto(out *BootstrapUsersParameters) {
	*out = *in
	if in.ConsoleAccess != nil {
		in, out := &in.ConsoleAccess, &out.ConsoleAccess
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapUsersParameters.
func (in *BootstrapUsersParameters) DeepCopy() *BootstrapUsersParameters {
	if in == nil {
		return nil
	}
	out := new(BootstrapUsersParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BrokerInitParameters) DeepCopyInto(out *BrokerInitParameters) {
	*out = *in
	...
	if in.BootstrapUsers != nil {
		in, out := &in.BootstrapUsers, &out.BootstrapUsers
		*out = make([]BootstrapUsersInitParameters, len(*in))
		for i := range *in {
...
func (in *BrokerObservation) DeepCopyInto(out *BrokerObservation) {
	*out = *in
	...
	if in.BootstrapUsers != nil {
		in, out := &in.BootstrapUsers, &out.BootstrapUsers
		*out = make([]BootstrapUsersObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *BrokerParameters) DeepCopyInto(out *BrokerParameters) {
	*out = *in
	...
	if in.BootstrapUsers != nil {
		in, out := &in.BootstrapUsers, &out.BootstrapUsers
		*out = make([]BootstrapUsersParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
