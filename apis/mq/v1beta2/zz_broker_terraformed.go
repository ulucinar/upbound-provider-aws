...
func (tr *Broker) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"bootstrap_users[*].password": "spec.forProvider.bootstrapUsers[*].passwordSecretRef", "ldap_server_metadata[*].service_account_password": "spec.forProvider.ldapServerMetadata[*].serviceAccountPasswordSecretRef", "user[*].password": "spec.forProvider.user[*].passwordSecretRef"}
}
