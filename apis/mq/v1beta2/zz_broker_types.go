...
type BootstrapUsersInitParameters struct {
...
type BootstrapUsersObservation struct {
...
type BootstrapUsersParameters struct {
...
type BrokerInitParameters struct {
	...
	BootstrapUsers []BootstrapUsersInitParameters `json:"bootstrapUsers,omitempty" tf:"bootstrap_users,omitempty"`
...
type BrokerObservation struct {
	...
	BootstrapUsers []BootstrapUsersObservation `json:"bootstrapUsers,omitempty" tf:"bootstrap_users,omitempty"`
...
type BrokerParameters struct {
	...
	// +kubebuilder:validation:Optional
	BootstrapUsers []BootstrapUsersParameters `json:"bootstrapUsers,omitempty" tf:"bootstrap_users,omitempty"`
