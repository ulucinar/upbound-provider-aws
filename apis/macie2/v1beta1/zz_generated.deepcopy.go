...
func (in *AndInitParameters) DeepCopyInto(out *AndInitParameters) {
	*out = *in
	if in.SimpleCriterion != nil {
		...
		*out = make([]SimpleCriterionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.TagCriterion != nil {
		...
		*out = make([]TagCriterionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ClassificationJobInitParameters) DeepCopyInto(out *ClassificationJobInitParameters) {
	*out = *in
	...
	if in.S3JobDefinition != nil {
		...
		*out = make([]S3JobDefinitionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ScheduleFrequency != nil {
		...
		*out = make([]ScheduleFrequencyInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ExcludesAndInitParameters) DeepCopyInto(out *ExcludesAndInitParameters) {
	*out = *in
	if in.SimpleScopeTerm != nil {
		...
		*out = make([]SimpleScopeTermInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.TagScopeTerm != nil {
		...
		*out = make([]TagScopeTermInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *IncludesAndInitParameters) DeepCopyInto(out *IncludesAndInitParameters) {
	*out = *in
	if in.SimpleCriterion != nil {
		in, out := &in.SimpleCriterion, &out.SimpleCriterion
		*out = make([]AndSimpleCriterionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.TagCriterion != nil {
		in, out := &in.TagCriterion, &out.TagCriterion
		*out = make([]AndTagCriterionInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *S3JobDefinitionInitParameters) DeepCopyInto(out *S3JobDefinitionInitParameters) {
	*out = *in
	if in.BucketCriteria != nil {
		...
		*out = make([]BucketCriteriaInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Scoping != nil {
		...
		*out = make([]ScopingInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ScopingIncludesAndInitParameters) DeepCopyInto(out *ScopingIncludesAndInitParameters) {
	*out = *in
	if in.SimpleScopeTerm != nil {
		in, out := &in.SimpleScopeTerm, &out.SimpleScopeTerm
		*out = make([]AndSimpleScopeTermInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.TagScopeTerm != nil {
		in, out := &in.TagScopeTerm, &out.TagScopeTerm
		*out = make([]AndTagScopeTermInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ScopingInitParameters) DeepCopyInto(out *ScopingInitParameters) {
	*out = *in
	if in.Excludes != nil {
		in, out := &in.Excludes, &out.Excludes
		*out = make([]ScopingExcludesInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Includes != nil {
		in, out := &in.Includes, &out.Includes
		*out = make([]ScopingIncludesInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
