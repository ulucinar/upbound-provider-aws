...
// GetInitParameters of this EBSSnapshotCopy
func (tr *EBSSnapshotCopy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EBSSnapshotCopy
func (tr *EBSSnapshotCopy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
