...
// GetInitParameters of this DefaultSubnet
func (tr *DefaultSubnet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DefaultSubnet
func (tr *DefaultSubnet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
