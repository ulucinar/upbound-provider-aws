...
// GetInitParameters of this TransitGatewayPolicyTable
func (tr *TransitGatewayPolicyTable) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TransitGatewayPolicyTable
func (tr *TransitGatewayPolicyTable) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
func (tr *TransitGatewayPolicyTable) LateInitialize(attrs []byte) (bool, error) {
	params := &TransitGatewayPolicyTableParameters{}
