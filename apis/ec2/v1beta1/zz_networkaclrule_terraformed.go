...
// GetInitParameters of this NetworkACLRule
func (tr *NetworkACLRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NetworkACLRule
func (tr *NetworkACLRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
