...
// GetInitParameters of this VPCDHCPOptions
func (tr *VPCDHCPOptions) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VPCDHCPOptions
func (tr *VPCDHCPOptions) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
