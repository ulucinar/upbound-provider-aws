...
// GetInitParameters of this DefaultVPC
func (tr *DefaultVPC) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DefaultVPC
func (tr *DefaultVPC) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
