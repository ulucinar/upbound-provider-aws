...
// GetInitParameters of this EBSDefaultKMSKey
func (tr *EBSDefaultKMSKey) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EBSDefaultKMSKey
func (tr *EBSDefaultKMSKey) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
