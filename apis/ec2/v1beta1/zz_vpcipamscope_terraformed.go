...
// GetInitParameters of this VPCIpamScope
func (tr *VPCIpamScope) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VPCIpamScope
func (tr *VPCIpamScope) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
