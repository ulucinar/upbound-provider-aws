...
// GetInitParameters of this CarrierGateway
func (tr *CarrierGateway) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CarrierGateway
func (tr *CarrierGateway) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
