...
// GetInitParameters of this AMI
func (tr *AMI) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AMI
func (tr *AMI) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
