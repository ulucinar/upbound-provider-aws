...
// GetInitParameters of this EBSSnapshot
func (tr *EBSSnapshot) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EBSSnapshot
func (tr *EBSSnapshot) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
