...
// GetInitParameters of this EBSVolume
func (tr *EBSVolume) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EBSVolume
func (tr *EBSVolume) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
