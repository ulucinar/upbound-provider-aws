...
func (tr *VPCEndpointSecurityGroupAssociation) GetID() string {
...
// GetInitParameters of this VPCEndpointSecurityGroupAssociation
func (tr *VPCEndpointSecurityGroupAssociation) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VPCEndpointSecurityGroupAssociation
func (tr *VPCEndpointSecurityGroupAssociation) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
func (tr *VPCEndpointSecurityGroupAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &VPCEndpointSecurityGroupAssociationParameters{}
