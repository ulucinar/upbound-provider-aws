...
// GetInitParameters of this AMICopy
func (tr *AMICopy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AMICopy
func (tr *AMICopy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
