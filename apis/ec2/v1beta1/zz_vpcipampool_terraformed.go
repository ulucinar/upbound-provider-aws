...
// GetInitParameters of this VPCIpamPool
func (tr *VPCIpamPool) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VPCIpamPool
func (tr *VPCIpamPool) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
