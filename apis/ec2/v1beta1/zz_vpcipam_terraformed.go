...
// GetInitParameters of this VPCIpam
func (tr *VPCIpam) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VPCIpam
func (tr *VPCIpam) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
