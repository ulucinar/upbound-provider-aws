...
// GetInitParameters of this ResolverConfig
func (tr *ResolverConfig) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ResolverConfig
func (tr *ResolverConfig) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
