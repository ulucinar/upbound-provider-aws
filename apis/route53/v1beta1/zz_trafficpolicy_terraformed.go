...
// GetInitParameters of this TrafficPolicy
func (tr *TrafficPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TrafficPolicy
func (tr *TrafficPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
