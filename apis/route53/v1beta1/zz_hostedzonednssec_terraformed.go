...
// GetInitParameters of this HostedZoneDNSSEC
func (tr *HostedZoneDNSSEC) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this HostedZoneDNSSEC
func (tr *HostedZoneDNSSEC) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
