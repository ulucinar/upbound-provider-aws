//go:build (resourcegroups || all) && !ignore_autogenerated
...
func (in *GroupInitParameters) DeepCopyInto(out *GroupInitParameters) {
	*out = *in
	...
	if in.ResourceQuery != nil {
		...
		*out = make([]ResourceQueryInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceQueryInitParameters) DeepCopyInto(out *ResourceQueryInitParameters) {
	*out = *in
	if in.Query != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceQueryInitParameters.
func (in *ResourceQueryInitParameters) DeepCopy() *ResourceQueryInitParameters {
	if in == nil {
		return nil
	}
	out := new(ResourceQueryInitParameters)
	in.DeepCopyInto(out)
	return out
}
