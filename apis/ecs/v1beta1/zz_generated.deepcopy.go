...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterCapacityProvidersDefaultCapacityProviderStrategyInitParameters) DeepCopyInto(out *ClusterCapacityProvidersDefaultCapacityProviderStrategyInitParameters) {
	*out = *in
	if in.Base != nil {
		in, out := &in.Base, &out.Base
		*out = new(int64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterCapacityProvidersDefaultCapacityProviderStrategyInitParameters.
func (in *ClusterCapacityProvidersDefaultCapacityProviderStrategyInitParameters) DeepCopy() *ClusterCapacityProvidersDefaultCapacityProviderStrategyInitParameters {
	if in == nil {
		return nil
	}
	out := new(ClusterCapacityProvidersDefaultCapacityProviderStrategyInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterCapacityProvidersInitParameters) DeepCopyInto(out *ClusterCapacityProvidersInitParameters) {
	*out = *in
	...
	if in.DefaultCapacityProviderStrategy != nil {
		...
		*out = make([]ClusterCapacityProvidersDefaultCapacityProviderStrategyInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
