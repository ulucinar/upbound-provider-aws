...
require (
	...
	github.com/crossplane/upjet v1.10.0
...
replace github.com/hashicorp/terraform-provider-aws => github.com/upbound/terraform-provider-aws v0.0.0-20251204202602-e18994d4394a
